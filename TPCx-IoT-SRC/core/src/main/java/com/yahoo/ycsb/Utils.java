...
public final class Utils {
  ...
  public static ThreadLocalRandom randomLong()
  {
    /*
     * COMMMITTEE DISCUSSION
     * Doug pointed out that the main benefit of using ThreadLocalRandom is that it avoids a global 
     * mutex around the RNG class. In general this is a good change.  What impact this will have on 
     * the workload is uncertain - it depends on how multi-threaded the YCSB driver is and what contention 
     * is currently seen - but in general I would expect this to be neutral to positive
     */
