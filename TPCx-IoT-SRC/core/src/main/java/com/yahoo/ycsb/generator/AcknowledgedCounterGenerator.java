...
public class AcknowledgedCounterGenerator extends CounterGenerator
{
	...
	{
        System.err.println("IF YOU SEE THIS YOU SHOULD NOT IN TPCx-IOT\n");
        /*
         *  COMMENTED OUT IN RANDOM INT TO LONG CONVERSION for TPCx-IOT.  This code should not be reached.
         *
