...
public abstract class DB {
  ...
  /**
   * Perform a range scan for a set of records in the database based on the key and time stamp filter. Each field/value pair from the result will be stored
   * in a HashMap.
   *
   * @param table The name of the table
   * @param key The  key of the sensor to use for read
   * @param timestamp The timestamp that you want to read after
   * @param fields The list of fields to read, or null for all of them
   * @param result1 A Vector of HashMaps, where each HashMap is a set field/value pairs for one record
   * @return The result of the operation.
   */
  public abstract Status scan(String table, String key, String client, String timestamp, Set<String> fields, long runStartTime,
