...
public class HBaseClient12 extends  com.yahoo.ycsb.db.HBaseClient10{
 /*private Configuration config = HBaseConfiguration.create();
    ...
    *//**
    ...
    public Status scan(String table, String filter, String timestamp,
        ...
        Scan s = new Scan(Bytes.toBytes(filter));
        //s.addFamily(HbaseJsonEventSerializer.COLUMFAMILY_SEARCH_BYTES);
        ResultScanner scanner = null;
        try {
        ValueFilter f1 = new ValueFilter(CompareOp.GREATER, ByteArrayComparable.parseFrom(Bytes.toBytes(timestamp)));
        ValueFilter f2 = new ValueFilter(CompareOp.EQUAL,ByteArrayComparable.parseFrom(Bytes.toBytes(filter)));
        s.setFilter(f1);
        s.setFilter(f2);
        ...
        // get results
            ...
            if (debug) {
                System.out.println("Error in getting/parsing scan result using filters: " + e);
            }
            return Status.ERROR;
